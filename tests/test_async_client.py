"""
Tests for the asynchronous Elfa client
"""
...
class TestAsyncElfaClientInit:
    """Test async client initialization"""

    def test_init_with_api_key(self):
        """Test successful initialization with API key"""
        client = AsyncElfaClient(api_key="test-key")
    ...
    def test_init_without_api_key(self):
        ...
        with pytest.raises(ValueError, match="API key is required"):
            AsyncElfaClient(api_key="")

    @pytest.mark.asyncio
    async def test_context_manager(self):
        """Test async client works as context manager"""
        async with AsyncElfaClient(api_key="test-key") as client:
            assert client.api_key == "test-key"


class TestAsyncElfaClientMakeRequest:
    """Test the async _make_request method"""

    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_successful_request(self, mock_request, async_client, mock_response):
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_request_with_params(self, mock_request, async_client, mock_response):
        """Test async request with query parameters"""
        response_data = {"success": True, "data": "test"}
        mock_request.return_value = mock_response(response_data)

        params = {"param1": "value1", "param2": None}
        result = await async_client._make_request("GET", "/test", params=params)
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_http_error_handling(self, mock_request, async_client, mock_response):
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_network_error_with_retry(self, mock_request, async_client):
        """Test async network error with retry logic"""
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_timeout_error(self, mock_request, async_client):
...
class TestAsyncElfaClientEndpoints:
    """Test individual async API endpoints"""

    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_ping(
        self, mock_request, async_client, mock_response, sample_ping_response
    ):
        """Test async ping endpoint"""
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_get_api_key_status(
        self, mock_request, async_client, mock_response, sample_api_key_status_response
    ):
        """Test async API key status endpoint"""
        mock_request.return_value = mock_response(sample_api_key_status_response)

        result = await async_client.get_api_key_status()
    ...
    async def test_get_trending_tokens(
        self, mock_request, async_client, mock_response, sample_trending_tokens_response
    ):
        """Test async trending tokens endpoint"""
        mock_request.return_value = mock_response(sample_trending_tokens_response)

        result = await async_client.get_trending_tokens(
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_get_keyword_mentions(
        self,
        mock_request,
        async_client,
        mock_response,
        sample_keyword_mentions_response,
    ):
        """Test async keyword mentions endpoint"""
        mock_request.return_value = mock_response(sample_keyword_mentions_response)

        result = await async_client.get_keyword_mentions(
    ...
    @pytest.mark.asyncio
    async def test_get_keyword_mentions_validation_error(self, async_client):
        """Test async keyword mentions without required parameters"""
        with pytest.raises(
            ValueError, match="Either keywords or account_name must be provided"
        ):
            await async_client.get_keyword_mentions()

    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_get_account_smart_stats(
        self,
        mock_request,
        async_client,
        mock_response,
        sample_account_smart_stats_response,
    ):
        """Test async account smart stats endpoint"""
        mock_request.return_value = mock_response(sample_account_smart_stats_response)

        result = await async_client.get_account_smart_stats(username="testuser")
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_get_trending_contract_addresses_twitter(
        self, mock_request, async_client, mock_response
    ):
        """Test async trending contract addresses Twitter endpoint"""
        response_data = {
            "success": True,
            "data": {
                "pageSize": 50.0,
        ...
        result = await async_client.get_trending_contract_addresses_twitter()
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_get_token_news(
        self, mock_request, async_client, mock_response, sample_token_news_response
    ):
        """Test async token news endpoint"""
        mock_request.return_value = mock_response(sample_token_news_response)

        result = await async_client.get_token_news(
...
class TestAsyncErrorHandling:
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_invalid_json_response(self, mock_request, async_client):
        """Test async invalid JSON response handling"""
...
class TestAsyncClientConcurrency:
    """Test async client concurrent operations"""
    ...
    async def test_concurrent_requests(
        ...
        tasks = [async_client.ping() for _ in range(5)]
...
class TestAsyncV1Endpoints:
    """Test async V1 API endpoints"""

    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_get_mentions_with_smart_engagement(
        self, mock_request, async_client, mock_response
    ):
        """Test async V1 mentions with smart engagement endpoint"""
        ...
        result = await async_client.get_mentions_with_smart_engagement(
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient.request", new_callable=AsyncMock)
    async def test_get_mentions_by_keywords_v1(
        self, mock_request, async_client, mock_response
    ):
        """Test async V1 keyword mentions endpoint"""
        # V1 method now uses V2 internally, so mock V2 response format
        response_data = {
            "success": True,
            "data": [
        ...
        result = await async_client.get_mentions_by_keywords_v1(
...
class TestAsyncEnhancedConfiguration:
    """Test async enhanced configuration options"""

    def test_async_enhanced_config_initialization(self):
        """Test async client initialization with enhanced config options"""
    ...
    def test_async_default_enhanced_config(self):
        """Test default values for async enhanced configuration"""
        client = AsyncElfaClient(api_key="test-key")
